...
class ScanStartedNotification extends Notification
{
    use Queueable;
    ...
    {
        return ['database']; // This makes it an "offline" notification
    }
    ...
    public function toArray($notifiable)
    {
        return [
            'title' => 'Scan Started',
            'message' => 'Your scan for ' . $this->nmapRequest->target . ' is now processing.',
